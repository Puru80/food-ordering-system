...
public class StudentDao extends DAOImpl<StudentRecord, com.bros.foodorderingsystem.model.tables.pojos.Student, String> {

    /**
     * Create a new StudentDao without any configuration
     */
    public StudentDao() {
        super(Student.STUDENT, com.bros.foodorderingsystem.model.tables.pojos.Student.class);
    }
    ...
    public StudentDao(Configuration configuration) {
        super(Student.STUDENT, com.bros.foodorderingsystem.model.tables.pojos.Student.class, configuration);
    }

    @Override
    public String getId(com.bros.foodorderingsystem.model.tables.pojos.Student object) {
        return object.getId();
    }
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchRangeOfId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchById(String... values) {
     ...
     */
    public com.bros.foodorderingsystem.model.tables.pojos.Student fetchOneById(String value) {
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchRangeOfName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchByName(String... values) {
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchRangeOfEmail(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchByEmail(String... values) {
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchByCreatedAt(LocalDateTime... values) {
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchRangeOfUpdatedAt(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.bros.foodorderingsystem.model.tables.pojos.Student> fetchByUpdatedAt(LocalDateTime... values) {
